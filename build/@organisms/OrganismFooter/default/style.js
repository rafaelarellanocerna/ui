...
styled__default["default"](framerMotion.motion.ul)(templateObject_2 || (templateObject_2 = tslib.__makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  flex-direction: row;\n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  flex-direction: row;\n  ", "\n"])), react.css(templateObject_1 || (templateObject_1 = tslib.__makeTemplateObject(["\n    @media only screen and (max-width: 1200px) {\n      display: none;\n    }\n  "], ["\n    @media only screen and (max-width: 1200px) {\n      display: none;\n    }\n  "]))));
styled__default["default"](framerMotion.motion.li)(templateObject_3 || (templateObject_3 = tslib.__makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: row;\n  margin: ", ";\n  cursor: pointer;\n  position: relative;\n\n  ", ";\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: row;\n  margin: ", ";\n  cursor: pointer;\n  position: relative;\n\n  ", ";\n"])), function (props) { return props.margin || '0px 25px 0px 0px'; }, function (_a) {
