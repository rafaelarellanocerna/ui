...
var index = require('../../debounce/index.js');
...
function useMeasure(_temp) {
  ...
  const [forceRefresh, resizeChange, scrollChange] = React.useMemo(() => {
    ...
    return [callback, resizeDebounce ? index(callback, resizeDebounce) : callback, scrollDebounce ? index(callback, scrollDebounce) : callback];
