...
class PinturaEditor extends React__default["default"].Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.editor = pintura.appendEditor(this.elementRef.current, props);
