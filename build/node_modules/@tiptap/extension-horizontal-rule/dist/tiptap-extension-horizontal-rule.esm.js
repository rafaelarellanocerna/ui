...
const HorizontalRule = tiptapCore_esm.Node.create({
    name: 'horizontalRule',
    addOptions() {
        return {
            HTMLAttributes: {},
    ...
    renderHTML({ HTMLAttributes }) {
        return ['hr', tiptapCore_esm.mergeAttributes(this.options.HTMLAttributes, HTMLAttributes)];
    },
    addCommands() {
        return {
                    ...
                    if (dispatch) {
                        ...
                        if ($to.nodeAfter) {
                            ...
                            if (node) {
                                ...
                                tr.setSelection(index.TextSelection.create(tr.doc, posAfter));
                            }
                        }
                        tr.scrollIntoView();
                    }
